          ...
          appointments.map((item, index) => (
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex py-2 border-b' key={item._id}>
              ...
              <div className='flex flex-col gap-2 justify-end'>
                {!item.cancelled && item.payment  && <button className='text-sm text-green-600 text-center sm:min-w-48 py-2 border rounded'>Paid</button>}
                ...
                {item.cancelled && <button className='text-sm text-red-600 text-center sm:min-w-48 py-2 border rounded'>Cancelled</button>}
              </div>
            </div>
          ))
        }
