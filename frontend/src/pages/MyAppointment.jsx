...
const MyAppointment = () => {
  ...
  console.log('doctors in MyAppointment:', doctors);
      ...
      <div>
        {
          doctors.slice(0, 3).map((item, index) => (
            <div className='grid grid-cols-[1fr_2fr] gap-4 sm:flex py-2 border-b' key={item._id}>
              <div>
                <img className='w-32 bg-green-50' src={item.image} alt={item.name} />
              </div>
              <div className='flex-1 text-sm text-zinc-600'>
                ...
                <p className='text-xs mt-1'><span className='text-sm text-neutral-700 font-medium'>Date & Time</span> 25 March 2023 | 10:00 AM</p>
              </div>
              <div></div>
