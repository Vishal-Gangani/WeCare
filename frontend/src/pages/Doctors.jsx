    ...
    <div>
      ...
      <div className='flex flex-col items-start sm:flex-row gap-5 mt-5'>
        ...
        <div className={`flex flex-col gap-2 text-sm text-grey-900 ${showfilter ? "flex" : "hidden sm:flex"}`}>
          ...
          <p onClick={() => speciality === 'Pediatrician' ? navigate('/doctors') : navigate('/doctors/Pediatrician')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-grey-300 rounded transition-all cursor-pointer ${speciality === "Pediatrician" ? "bg-green-100 text-black" : ""}`}>Pediatrician</p>
