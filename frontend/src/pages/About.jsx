  ...
  return (
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        <img className='w-full md:max-w-[400px] rounded-xl shadow-lg' src={assets.about_image} alt="About Us" />
        <div className='flex flex-col justify-center gap-8 md:w-2/4 text-gray-800 text-base bg-white p-8 rounded-xl shadow-md'>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 py-8 md:px-12 md:py-10 flex flex-col gap-5 text-[-15px] hover:bg-primary hover:text-white text-gray-600 cursor-pointer duration-300'>
