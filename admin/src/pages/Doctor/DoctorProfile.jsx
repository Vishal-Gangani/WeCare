    ...
    <div>
      <div className="flex flex-col gap-4 m-5">
        ...
        <div className="flex-1 border border-stone-100 p-8 py-7 rounded-lg bg-white">
          ...
          <p className="mt-3 text-gray-600 font-medium">Appointment Fee: <span className="text-gray-800">{isEdit ? <input type="number" onChange={(e) => setProfileData(prev=>({ ...prev, fees: e.target.value }))} value={profileData.fees} /> : profileData.fees}</span></p>
          ...
          <div className="flex gap-2 py-2">
            ...
            {isEdit ? <input type="text" onChange={(e) => setProfileData(prev=>({ ...prev, address: { ...prev.address, line2: e.target.value } }))} value={profileData.address?.line2} /> : profileData.address?.line2}</p>
             ...
             <input onChange={(e) => isEdit && setProfileData(prev => ({ ...prev, available: e.target.checked }))} checked={profileData.available} type="checkbox" />
